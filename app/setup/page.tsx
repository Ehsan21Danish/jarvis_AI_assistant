        ...
        <div className="min-h-screen bg-black text-white font-mono selection:bg-cyan-500/30 overflow-x-hidden relative flex items-center justify-center p-4">
            ...
            <div className="relative z-10 w-full max-w-3xl">
                ...
                <form onSubmit={handleSubmit} className="space-y-8 animate-in fade-in zoom-in-95 duration-700 delay-150">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <Input
                                        id="user_id"
                                        name="user_id"
                                        placeholder="unique_handle (e.g. ehsan_01)"
                                        required
                    ...
                    {/* Owner Permissions */}
                    <div className="relative p-6 rounded-xl border border-red-500/30 bg-slate-950/60 backdrop-blur-md">
                        <div className="absolute top-0 right-0 p-2 text-[10px] text-red-700 font-bold tracking-widest opacity-70">OWNER PERMISSION</div>
                        <label className="flex items-start gap-3 cursor-pointer">
                            ...
                            <span>
                                ...
                                <span className="mt-1 block text-xs text-cyan-700/90 leading-relaxed">
                                    Allows Jarvis to open applications and browser tabs when the owner gives voice commands. This does not allow arbitrary terminal commands.
                                </span>
                            </span>
                        </label>
